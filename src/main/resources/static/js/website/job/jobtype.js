...
function edit(e){
    $("#jobtypeid1").val($(e).attr("a1"));
    $("#jobtypename1").val($(e).attr("a2"));
...
//编辑信息
function updatetype() {
    var jobtypeid= $("#jobtypeid1").val();
    var typename=$("#jobtypename1").val();
    var n_sort=$("#n_sort1").val();
    $.ajax({
        url :'/jobtype/updatejobtype.do',
        type : 'POST',
        timeout : 20000,
        data:{
            jobtypeid:jobtypeid,
...
function formValidate1(e) {
    var str = '';
    // 判断名称
    if($.trim($('#jobtypename1').val()).length == 0) {
        str += '分类名称没有输入\n';
        $('#typename1').focus();
    }
...
function formValidate(e) {
    var str = '';
    // 判断名称
    if($.trim($('#jobtypename').val()).length == 0) {
        str += '分类名称没有输入\n';
        $('#jobtypename').focus();
    }
