...
public final class SessionUtils {
	 ...
	 */
	 public static String getAppKey(){//uwd1c0sxurgk1  生产环境
			return "uwd1c0sxurgk1";//pvxdm17jpclwr  开发环境
	 }
	 /**
	  * 获取appSecret
	  * @return
	 ...
	 public static String getAppSecret(){//3jewcY1Gw2  生产环境
			return "3jewcY1Gw2";//6kR9lgvRca5gil  开发环境
	 }
//	 /**
//	  * 从session中获取用户信息
//	  * @param request
//	  * @return SysUser
//	  */
//	 public static Dept getDept(HttpServletRequest request){
//		return (Dept)request.getSession(true).getAttribute(SESSION_USER);
//	 }
