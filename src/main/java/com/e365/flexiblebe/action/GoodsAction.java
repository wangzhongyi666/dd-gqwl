...
import com.e365.flexiblebe.bean.GoodsOrder;
...
import com.e365.flexiblebe.service.GoodsOrderService;
import com.e365.flexiblebe.service.GoodsService;
import com.e365.flexiblebe.service.RedeemCodeService;
import com.e365.flexiblebe.service.SysUserService;
import com.e365.flexiblebe.utils.*;
    ...
    public void uploadExcel(@RequestParam(value = "file", required = false) MultipartFile file,
        ...
        for(int i = 1;i<=sheet1.getLastRowNum();i++){
            ...
            if(StringUtils.isNotEmpty(gname)&&StringUtils.isNotEmpty(redeem_code)
                ...
                if(!DateUtil.validateFormat(term_of_validity_end)){
